...
import Flexbox from 'flexbox-react';
       ...
       textAlign: "center"
        ...
        class List extends React.Component {
          ...
          return (
           ...
           <h5 style={fontStyle}> {this.props.website} </h5>
  ...
  export default class Counselors extends React.Component {
     ...
     render () {
       ...
       return (
        <div>
         <h1 style = {counselorsStyle}> Find a Local Counselor Near You to Receive the Help you Need </h1>
