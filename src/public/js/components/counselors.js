          ...
          <Jumbotron style={{backgroundImage:"url('./css/img/counsel.png')", backgroundPosition: "center"}}>
            ...
            <JumbotronCol style={{width: '60%'}}>
              <div style={{height: '400px', paddingTop: '125px', paddingBottom:'20px'}}>
                ...
                <h3>Maintaining mental and emotional health is just as important as physical well-being.</h3>
              </div>
           </JumbotronCol>
         </Jumbotron>
